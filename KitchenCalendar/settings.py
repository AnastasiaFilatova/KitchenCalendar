# Django settings for KitchenCalendar project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Anastasiia Filatova', 'anastasia.n.filatova@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'kitchen_calendar.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'r!_@984-za!z0+^3em5_(i7zv=t+ydz%z9@%*7x99ariyfy%&a'
...
ROOT_URLCONF = 'KitchenCalendar.urls'
